...
export const redisClient: ReturnType<typeof createRedisConnection> = createRedisConnection(redisUrl);
export const videoQueue: ReturnType<typeof createQueue> = createQueue(transcodingQName, redisClient);